    ...
    public static void main(String[] args) {
        ...
        int[][] Grid = new int[][]
                {{ 8,  2, 22, 97, 38, 15,  0, 40,  0, 75,  4,  5,  7,
                 ...
                 {78, 17, 53, 28, 22, 75, 31, 67, 15, 94,  3, 80,  4,
                  62, 16, 14,  9, 53, 56, 92},
                 {16, 39,  5, 42, 96, 35, 31, 47, 55, 58, 88, 24,  0,
                  17, 54, 24, 36, 29, 85, 57},
                 {86, 56,  0, 48, 35, 71, 89,  7,  5, 44, 44, 37, 44,
                  60, 21, 58, 51, 54, 17, 58},
                 {19, 80, 81, 68,  5, 94, 47, 69, 28, 73, 92, 13, 86,
                  52, 17, 77,  4, 89, 55, 40},
                 { 4, 52,  8, 83, 97, 35, 99, 16,  7, 97, 57, 32, 16,
                  26, 26, 79, 33, 27, 98, 66},
                 {88, 36, 68, 87, 57, 62, 20, 72,  3, 46, 33, 67, 46,
                  55, 12, 32, 63, 93, 53, 69},
                 { 4, 42, 16, 73, 38, 25, 39, 11, 24, 94, 72, 18,  8,
                  46, 29, 32, 40, 62, 76, 36},
                 {20, 69, 36, 41, 72, 30, 23, 88, 34, 62, 99, 69, 82,
                  67, 59, 85, 74,  4, 36, 16},
                 {20, 73, 35, 29, 78, 31, 90,  1, 74, 31, 49, 71, 48,
                  86, 81, 16, 23, 57,  5, 54},
                 { 1, 70, 54, 71, 83, 51, 54, 69, 16, 92, 33, 48, 61,
                  43, 52,  1, 89, 19, 67, 48}};

        int LargestProduct = 0;
        int Temp = 0;

        /* Loop over each index of the grid */
        for(int I = 0; I < 20; I++) {
            for(int J = 0; J < 20; J++) {
                /* Try to multiply the number with the three numbers
                 * to the right */
                if(J < 17) {
                ...
                /* Try to multiply the number with the three numbers
                 * diagnonally to the bottom right */
                if(J < 17 && I < 17) {
        ...
        /* Print the answer */
        System.out.format("%d%n", LargestProduct);
